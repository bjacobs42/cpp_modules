...
/*   Updated: 2023/08/11 20:28:56 by bjacobs          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
ClapTrap::ClapTrap(std::string name) : \
	...
	std::cout << "String constructer called" << std::endl;
}
...
void	ClapTrap::attack(const std::string & target) {
	...
	this->_energyPoints--;
	std::cout << this->_name << attacks[randomizer(5)] << target << "'s " << areas[randomizer(7)]
